    ...
    <script>
        ...
        info.update = function(props) {
            this._div.innerHTML = '<h4>Kabupaten/Kota</h4>' + (props ?
                '<b>' + props.name + '</b><br />' + props.population.toLocaleString() + ' Jumlah Penduduk' :
                'Hover over a region');
        };
...
<?php /**PATH C:\xampp\htdocs\SIG\chroropleth-map\resources\views/chroropleth_map.blade.php ENDPATH**/ ?>